...
NOTIFICATION_EMAIL = os.getenv("NOTIFICATION_EMAIL", "grachevilia09@yandex.ru")
BRIEF_NOTIFICATION_EMAIL = os.getenv("BRIEF_NOTIFICATION_EMAIL", NOTIFICATION_EMAIL)

raw_fernet_key = os.getenv("FIELD_ENCRYPTION_KEY")
FIELD_ENCRYPTION_KEY = (
    raw_fernet_key.encode()
    if raw_fernet_key
